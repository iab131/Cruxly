    ...
    return (
        <div className="max-w-2xl mx-auto p-8 space-y-8">
            <div className="text-center space-y-4">
                 <div className="w-16 h-16 bg-gradient-to-br from-blue-950 via-blue-700 to-sky-400 rounded-3xl flex items-center justify-center mx-auto shadow-lg shadow-blue-950/25">
                    <Sparkles className="w-8 h-8 text-white" />
                 </div>
                 <h1 className="text-3xl font-bold text-blue-950 tracking-tight">AI Beta Solver</h1>
            ...
            <Card className="rounded-3xl border-slate-200 border-dashed border-2 shadow-none bg-slate-50/50">
                <CardHeader>
            ...
            <div className="bg-blue-50 text-blue-800 p-4 rounded-2xl text-sm leading-relaxed border border-blue-100">
